        ...
        <div className="mx-auto mt-20 max-w-lg">
          <div className="relative w-full rounded-lg bg-blue-100 p-4 ps-20 md:h-64 md:ps-48">
            <div className="relative h-full w-full rounded-lg bg-gray-50 p-4">  
              <table className="my-9 w-full text-sm">
                <tbody>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td>
                      <a
                        href="mailto:grevizirsky@gmail.com"
                        className="underline hover:text-blue-800"
                      >
                        grevizirsky@gmail.com
                      </a>
                    </td>
                  </tr>
                  <tr>
            ...
            <div className="absolute -left-2 -top-4 h-24 w-20 rounded-lg bg-gray-600 bg-[url(./assets/img_profile.jpg)] bg-cover bg-center md:-left-12 md:-top-12 md:h-72 md:w-56"></div>
          </div>
        </div>
      </section>
    )
