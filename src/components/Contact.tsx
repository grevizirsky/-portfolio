...
export default function Contact(){
    ...
    const sendEmail = (event: FormEvent<HTMLFormElement>) => {
      ...
      const contacts = [
        {
          name: "WhatsApp",
          description: "+55 11 9.9209-9856",
          link: "https://wa.me/5511992099856",
          icon: <FaWhatsapp className="h-10 w-10" />,
        },
        {
          name: "Email",
          description: "grevizirsky@gmail.com",
          link: "mailto:grevizirsky@gmail.com",
          icon: <HiOutlineEnvelope className="h-10 w-10" />,
        },
        {
          name: "Ermelino Matarazzo",
          description: "SP, São Paulo",
          link: "https://maps.app.goo.gl/QT5CRYkXD8sQZqcYA",
