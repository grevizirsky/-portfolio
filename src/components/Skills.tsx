...
export default function Skills() {
  const educations = [
    {
      name: "Curso Web Design Completo: HTML, CSS3 e JS",
    },
    {
      name: "Python 3 - Curso em Video",
    },
    {
  ...
  const skills = [
    ...
    {
      name: "Python",
      icon: "./src/assets/python_logo.png",
      level: 50,
    },
  ]
      ...
      <div className="container mx-auto max-w-4xl p-4 py-12">
        <div className="relative mb-4 p-4 text-center">
          ...
          <p className="relative text-sm text-gray-700">
            Front-end Developer | React.js | React Native | Python | TypeScript
            | JavaScript
          </p>
